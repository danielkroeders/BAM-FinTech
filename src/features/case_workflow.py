...
DEMO_SCENARIOS = {
    ...
    "A2M Logistics Loan": {
        ...
        "suspicious_transfer_ratio": 0.06,
        "collateral_ratio": 0.62,
        "country_risk_score": 0.18,
        "free_cash_flow": 260000,
        "monthly_burn_rate": 75000,
        "expected_runway_months": 9,
        "forecast_revenue_cagr": 0.13,
        ...
        "document_edit_count": 3,
        "late_stage_change_count": 1,
        "process_deviation_score": 0.16,
        "email_domain_age_months": 72,
        "website_age_months": 84,
        "bank_account_age_months": 68,
        "location_mismatch_score": 0.04,
        "duplicate_contact_score": 0.03,
        "related_party_exposure_score": 0.10,
        "counterparty_concentration_score": 0.45,
        "shared_identifier_score": 0.02,
        "narrative_contradiction_score": 0.12,
        "loan_purpose_context": "Applicant requests a EUR 2 million facility to fund fleet capacity and working capital for a new long-term logistics contract.",
        "current_business_context": "Recent fuel-cost increases compressed margins, but the company remains cash-flow positive and has stable payment behavior.",
        "future_business_context": "Management expects the new contract to improve utilization while fuel hedging and route optimization protect margins.",
        "ceo_context": "CEO highlights a signed multi-year contract with a large client and expects higher route density in Western Europe.",
        "cfo_context": "CFO notes that fuel costs recently pressured margins, but DSCR remains manageable under the proposed loan terms.",
        "coo_context": "COO plans phased fleet utilization improvements rather than aggressive headcount expansion.",
    },
