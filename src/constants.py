FIELD_HELP = {
    ...
    "collateral_value": "Estimated value of assets the company can offer as collateral.",
    "collateral_ratio": "Estimated collateral value divided by requested loan amount, calculated from applicant-provided amounts.",
    ...
    "monthly_burn_rate": "Average monthly cash outflow based on recent operating activity.",
    "cash_balance_at_application": "Cash currently available in business accounts at application date.",
    "expected_runway_months": "Estimated months the applicant can sustain current cash outflow with available cash, calculated automatically.",
    ...
    "current_ratio": "Current assets divided by current liabilities, calculated automatically.",
    "quick_ratio": "Liquid assets divided by current liabilities, calculated automatically.",
