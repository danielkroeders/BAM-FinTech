...
TUTORIALS = [
    ...
    },
    {
        ...
        "time": "7 min",
        "level": "Intermediate",
        "summary": "Explore the borrower-facing view, improvement actions, scenarios, evidence, and peers.",
        "features": ["Health snapshot", "Next actions", "What-if tools", "Peer view"],
        "objectives": [
            "Explain the current credit-health result",
            "Test a stronger operating scenario",
            "Review evidence and peer context",
        ],
        "steps": [
            {
                "title": "Select a credit-health file",
                "body": "Use Credit health file to choose the latest scored case or a portfolio application. The summary shows current grade, risk score, lender view, and expected runway.",
                "action": "Use the latest scored case when moving directly from Personal Workspace.",
                "tip": "This is a borrower-facing concept preview using the same synthetic data as the analyst workspace.",
            },
            {
                "title": "Explain the current position",
                "body": "Company Snapshot grounds the assessment in business scale and affordability. Most Useful Next Actions turns the strongest issues into practical improvement suggestions.",
                "action": "Connect each suggested action to a value in the company snapshot.",
                "tip": "Phrase recommendations as ways to strengthen evidence or resilience, not promises of approval.",
            },
            {
                "title": "Run a what-if scenario",
                "body": "Adjust revenue growth, FCF margin, cost pressure, debt reduction, contract evidence, and document completeness. The comparison table recalculates the modeled scenario.",
                "action": "Change one assumption at a time before testing a combined improvement plan.",
                "tip": "A better modeled grade is directional; the underlying evidence still needs verification.",
            },
            {
                "title": "Add benchmark and source context",
                "body": "Peer Benchmark compares the case with synthetic peers. Evidence Sources shows data coverage. Five-Year View presents the forecast path for revenue, employees, cash flow, and debt.",
                "action": "Use all three tabs to separate present evidence from forward-looking assumptions.",
                "tip": "Forecasts are most useful when their supporting contracts and documents are present.",
            },
        ],
    },
    {
        ...
        "time": "8 min",
        "level": "Advanced",
        "summary": "Run a deterministic, hosted, or local second review and inspect SHAP drivers.",
        "features": ["Provider choice", "Second review", "AI comparison", "SHAP drivers"],
        "objectives": [
        ...
        "steps": [
            ...
            },
            {
                ...
                "body": "Every run reports selected provider, source, run time, and status. Successful hosted or local LLM output can also show a qualitative AI review score, implied grade, and comparison with the selected ML grade; deterministic output does not create those AI comparison metrics.",
                "action": "Investigate any material disagreement instead of averaging the two outputs.",
                "tip": "The AI review score is qualitative and is not a calibrated default probability.",
            },
            {
