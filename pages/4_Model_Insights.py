    ...
    [
        {
            ...
            "Balanced accuracy": format_score(
                spec.metrics.get("balanced_accuracy", 0), 3
            ),
            "Precision top 10%": format_score(
                spec.metrics.get("precision_at_10pct", 0), 3
            ),
        }
...
queue_rows = pd.DataFrame(
    [
        {
            "Review queue": "Top 5%",
            "Precision": format_score(metrics["precision_at_5pct"], 3),
        },
        {
            "Review queue": "Top 10%",
            "Precision": format_score(metrics["precision_at_10pct"], 3),
        },
        {
            "Review queue": "Top 20%",
            "Precision": format_score(metrics["precision_at_20pct"], 3),
        },
    ]
)
...
with metric_middle:
    numerator_column = st.selectbox(
        ...
        numeric_options,
        index=(
            numeric_options.index("requested_amount")
            if "requested_amount" in numeric_options
            else 0
        ),
    )
...
with metric_right:
    ...
    denominator_column = st.selectbox(
        ...
        denominator_options,
        index=(
            denominator_options.index("annual_revenue")
            if "annual_revenue" in denominator_options
            else 0
        ),
    )
...
importance_chart = (
    ...
    .configure_axis(
        domain=False, gridColor="rgba(148, 163, 184, 0.28)", labelColor="#475569"
    )
...
derived_signals = pd.DataFrame(
    [
        {
            "Signal": "debt_to_revenue_ratio",
            "Purpose": "Measures financial pressure from existing obligations.",
        },
        {
            "Signal": "request_to_revenue_ratio",
            "Purpose": "Compares requested exposure with business scale.",
        },
        {
            "Signal": "loan_velocity_score",
            "Purpose": "Captures rapid recent borrowing behavior and possible credit stacking.",
        },
        {
            "Signal": "payment_stress_score",
            "Purpose": "Combines late-payment behavior with debt pressure.",
        },
        {
            "Signal": "collateral_gap_ratio",
            "Purpose": "Estimates uncovered exposure when collateral is weak.",
        },
        {
            "Signal": "external_financing_pressure",
            "Purpose": "Approximates financing pressure from request size, debt, and loan velocity.",
        },
        {
            "Signal": "financial_distress_score",
            "Purpose": "Combines debt, payment, collateral, and short-history stress.",
        },
        {
            "Signal": "transaction_anomaly_score",
            "Purpose": "Summarizes suspicious transfers, payment stress, country risk, and borrowing velocity.",
        },
        {
            "Signal": "company_scale_mismatch_score",
            "Purpose": "Flags employee scale that appears stretched relative to requested exposure.",
        },
        {
            "Signal": "governance_complexity_score",
            "Purpose": "Approximates review complexity from entity type, region, history, and country risk.",
        },
        {
            "Signal": "free_cash_flow",
            "Purpose": "Captures annual cash generation available after operating and investment needs.",
        },
        {
            "Signal": "monthly_burn_rate",
            "Purpose": "Estimates monthly cash consumption at application date.",
        },
        {
            "Signal": "cash_flow_to_revenue_ratio",
            "Purpose": "Shows whether reported revenue converts into free cash flow.",
        },
        {
            "Signal": "expected_runway_months",
            "Purpose": "Estimates how long cash reserves can cover current burn.",
        },
        {
            "Signal": "cash_flow_pressure_score",
            "Purpose": "Combines negative cash flow and burn intensity into a liquidity stress signal.",
        },
        {
            "Signal": "runway_risk_score",
            "Purpose": "Flags applicants with short expected runway.",
        },
        {
            "Signal": "cash_conversion_risk_score",
            "Purpose": "Highlights weak cash conversion relative to reported revenue.",
        },
        {
            "Signal": "forecast_revenue_cagr",
            "Purpose": "Captures the applicant's expected annual revenue growth over five years.",
        },
        {
            "Signal": "forecast_employee_cagr",
            "Purpose": "Captures expected employee growth supporting the revenue plan.",
        },
        {
            "Signal": "forecast_fcf_margin_year5",
            "Purpose": "Represents the target year-five free-cash-flow margin.",
        },
        {
            "Signal": "planned_debt_reduction_pct",
            "Purpose": "Represents the applicant's planned debt reduction over five years.",
        },
        {
            "Signal": "forecast_plan_aggressiveness_score",
            "Purpose": "Flags ambitious growth and margin plans that may not be supported by current signals.",
        },
        {
            "Signal": "forecast_execution_risk_score",
            "Purpose": "Combines plan ambition, liquidity risk, and confidence into a forecast execution signal.",
        },
        {
            "Signal": "forecast_hiring_efficiency_risk_score",
            "Purpose": "Measures whether headcount growth supports projected revenue growth.",
        },
        {
            "Signal": "forecast_debt_service_risk_score",
            "Purpose": "Measures whether debt reduction plans are strained by cash-flow pressure.",
        },
        {
            "Signal": "interest_rate",
            "Purpose": "Captures the offered annual loan rate used in repayment and stress calculations.",
        },
        {
            "Signal": "annual_interest_expense",
            "Purpose": "Estimates first-year interest burden on the requested facility.",
        },
        {
            "Signal": "annual_debt_service",
            "Purpose": "Estimates first-year principal and interest payments from rate, amount, and term.",
        },
        {
            "Signal": "debt_service_coverage_ratio",
            "Purpose": "Compares free cash flow with estimated annual debt service.",
        },
        {
            "Signal": "stressed_debt_service_coverage_ratio",
            "Purpose": "Recomputes DSCR under a +2 percentage point interest-rate stress.",
        },
        {
            "Signal": "debt_service_stress_score",
            "Purpose": "Flags repayment sensitivity when DSCR or stressed DSCR is weak.",
        },
        {
            "Signal": "cash_conversion_cycle_days",
            "Purpose": "Combines receivables, inventory, and payables timing into a working-capital pressure view.",
        },
        {
            "Signal": "document_completeness_score",
            "Purpose": "Measures whether the expected application package is present without requiring actual file upload.",
        },
        {
            "Signal": "document_quality_risk_score",
            "Purpose": "Flags missing documents, repeated edits, and late-stage changes.",
        },
        {
            "Signal": "process_integrity_risk_score",
            "Purpose": "Captures workflow deviations and unusual resubmission behavior.",
        },
        {
            "Signal": "identity_verification_risk_score",
            "Purpose": "Summarizes digital footprint age, bank-account age, and mismatch signals.",
        },
        {
            "Signal": "working_capital_pressure_score",
            "Purpose": "Combines current ratio, quick ratio, cash conversion cycle, and receivables pressure.",
        },
        {
            "Signal": "financial_statement_anomaly_score",
            "Purpose": "Captures revenue/cash-flow mismatch, receivables pressure, and unsupported margin improvement.",
        },
        {
            "Signal": "related_party_network_risk_score",
            "Purpose": "Summarizes related-party exposure, concentrated counterparties, and shared identifiers.",
        },
        {
            "Signal": "narrative_consistency_risk_score",
            "Purpose": "Flags contradictions between applicant context, document status, and financial signals.",
        },
    ]
)
st.dataframe(derived_signals, width="stretch", hide_index=True)
st.caption(
    "These derived fields are computed automatically from portfolio and workspace intake data; analysts do not need to enter them manually."
)
